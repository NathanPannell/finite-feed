...
class Settings(BaseSettings):
    ...
    delivery_enabled: bool = Field(default=True, alias="DELIVERY_ENABLED")
    model_daily_request_limit: int = Field(default=40, ge=0, le=10000, alias="MODEL_DAILY_REQUEST_LIMIT")
    youtube_daily_request_limit: int = Field(default=1000, ge=0, le=10000, alias="YOUTUBE_DAILY_REQUEST_LIMIT")
    minimum_relevance: float = Field(default=0.25, ge=0, le=1, alias="MINIMUM_RELEVANCE")
