...
export default function Home() {
  return <div className="landing">
    ...
    <header className="landing-nav"><Link className="signal-wordmark" href="/"><span aria-hidden="true">F/</span>Finite Feed</Link><nav aria-label="Primary navigation"><Link href="/match">Try Match Lab</Link><Link href="/app">Sign in</Link></nav></header>
    <main id="main">
      <section className="landing-hero">
        <div className="landing-lead"><h1>Fewer things.<br /><span>Better chosen.</span></h1><p>A personal YouTube digest for the ideas you actually care about. Thoughtful picks from your sources, delivered to Telegram on your schedule.</p><Link className="landing-cta" href="/app">Shape your feed <span aria-hidden="true">↗</span></Link><p className="landing-note">Private beta · Sign in with Google to get started.</p></div>
